...
class TestSampleService(unittest.TestCase):
    ...
    def test_set_sample_stamp_old_same_present(self):
        ...
        self.assertIs(old_stamp, self.under_test.current_stamp)
